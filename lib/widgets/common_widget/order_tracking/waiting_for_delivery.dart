...
class WaitingForDelivery extends StatefulWidget {
  ...
  @override
  State<WaitingForDelivery> createState() => _WaitingForDeliveryState();
}
        ...
        child: Column(
          children: [
            ...
            for (var order in _orderTracking) ...[
              ...
              if((order['userId'].toString() == ordersViewModel.userId.toString()) && (order['status'].toString() == 'Waiting Delivery'))
                Container(
