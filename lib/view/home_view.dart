                    ...
                    suffixIcon: IconButton(
                      icon: Image.asset(
                        controller.isListening
                            ? ImageAsset.microphone  // Hiển thị hình ảnh micro khi đang nghe
                            : ImageAsset.microphoneUn,  // Hiển thị hình ảnh micro khi không nghe
                        height: 24,  // Đặt chiều cao của hình ảnh (tuỳ chỉnh theo nhu cầu)
                        width: 24,   // Đặt chiều rộng của hình ảnh (tuỳ chỉnh theo nhu cầu)
                      ),
                      onPressed: () {
                        controller.toggleListening();  // Chuyển đổi trạng thái của micro
                      },
                    ),
